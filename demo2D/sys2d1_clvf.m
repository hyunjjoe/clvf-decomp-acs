...
params.u_max = 4; % maximum control input
params.u_min  = -4; % minimum control input 

%obj = Cart1D(x, uMin, uMax)
uRange = [ params.u_min , params.u_max ];
dRange = {0,0};
sys1 = sys2d1(0, uRange, dRange, 1);
...
save('demo2D/data_sys1.mat','data1')
save('demo2D/g_sys1.mat','g')
