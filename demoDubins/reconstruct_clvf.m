...
%hold on;
%[g_adms, adms2d] = proj(g, u_adms, [0,0,1], 'min');
%visFuncIm(g_adms, adms2d, 'green', 0.5)
visSetIm(g,data_intersection2,'green',1);
hold on;
visSetIm(g,u_adms,'red',1);
