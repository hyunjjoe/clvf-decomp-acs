...
N = [101; 151];         % Number of grid points per dimension
...
save('demoDubins/data_sys2.mat','data1')
save('demoDubins/g_sys2.mat','g')
...
HJIextraArgs.visualize.xTitle = "x2";
HJIextraArgs.visualize.yTitle = "x3";
